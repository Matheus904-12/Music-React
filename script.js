...
class CardProfile extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
      index: 3,
      currentTime: '0:00',
      musicList: [{ name: 'Calling', author: 'Metro Boomin', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8sKmV4LG_pJeb5jidR8zQ10DIVH_i5yXBeWR__iDkenvw0vbPhc3YGk1pl2wv9M6t5xw&usqp=CAU', audio: 'SPI.mp3',},

      { name: 'Woo Baby (feat. Chris Brown)', author: 'Pop Smoke', img: 'https://polifoniaperiferica.com.br/wp-content/uploads/2021/07/Pop-Smoke-de-Faith-1-800x509.jpg', audio: 'POP.mp3',},
     
      { name: 'Hotel in Japan', author: 'Playboi Carti', img: 'https://i.ytimg.com/vi/x2E5NtVB4Y4/maxresdefault.jpg', audio: 'PLAY.mp3',},

      { name: 'Over You', author: 'Vacations', img: 'https://newleasemusic.files.wordpress.com/2024/01/vacations-terms-conditions-photo-by-charlie-hardy.jpg', audio: 'PVACATIONS.mp3',}],
